...
* A perfect simulation cannot guess, skip, or make any intermediate steps of what is being simulated. For each frame of the perfect simulation, (K, X), at every respective time-interval K the state of what is being simulated must exactly match X. Additionally, a perfect prediction must be a state taken from a perfect simulation. 
