...
* A perfect simulation, $T$, cannot guess, or make any intermediate steps of what is being simulated, $S$. $T$ must be fully contained in sequential order within $S$. Additionally, a perfect prediction must be a state taken from a perfect simulation. 
